// api-worker/src/handlers/storage/presigned-url-to-download.handler.ts
...
export const getPresignedUrlToDownloadHandler = async (
    ...
    try {
        ...
        return c.json(
            GetPresignedUrlToDownloadSuccessResponseSchema.parse({
                url: signedUrl,
                method: 'GET',
            }),
            200
